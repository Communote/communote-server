...
/**
 * Parameters for the query management test
 *
 * @author Communote GmbH - <a href="http://www.communote.com/">http://www.communote.com/</a>
 *
 */
public class QueryManagementParameterNameProvider extends FilterApiParameterNameProvider {
     ...
     */
    public final static QueryManagementParameterNameProvider INSTANCE = new QueryManagementParameterNameProvider();

    /**
     * @return the paramEntityId
     */
    public static String getNameForEntityId() {
