...
$p.core = function(sel, ctxt, plugins){
	// hack to get iframe support, won't work in all cases (e.g. when called with string selector and without context)
	...
	// save actual document object in closure variable to override the global object
    document = templates[0].ownerDocument;
