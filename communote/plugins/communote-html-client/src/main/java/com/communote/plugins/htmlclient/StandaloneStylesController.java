...
@Component
@Provides
@Instantiate(name = "StandaloneStylesController")
@UrlMapping("/*/resources/styles/htmlClient-standalone-styles.css")
public class StandaloneStylesController implements Controller {

    private final String bundleName;

    public StandaloneStylesController(BundleContext bundleContext) {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        return new ModelAndView("communote.plugins.htmlClient.styles.standalone", data);
    }
