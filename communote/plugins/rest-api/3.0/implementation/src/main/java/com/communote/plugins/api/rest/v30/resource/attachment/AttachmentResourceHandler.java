 ...
 */
public class AttachmentResourceHandler
extends
DefaultResourceHandler<CreateAttachmentParameter, DefaultParameter, DeleteAttachmentParameter,
GetAttachmentParameter, DefaultParameter> {
    ...
    protected Response handleCreateInternally(CreateAttachmentParameter createParameter,
            String requestedMimeType, UriInfo uriInfo, String requestSessionId, Request request)
                    throws ParameterValidationException, ResponseBuildException,
                    ExtensionNotSupportedException, FileUploadException, IOException,
                    IllegalRequestParameterException, AttachmentIsEmptyException, AuthorizationException {
        ...
        if (httpReq.getContentType().startsWith(MediaType.MULTIPART_FORM_DATA)) {
            ...
            boolean isBase64 = isBase64Value != null && Boolean.parseBoolean(isBase64Value);
    ...
    @Override
    protected Response handleDeleteInternally(DeleteAttachmentParameter deleteParameter,
            String requestedMimeType, UriInfo uriInfo, String requestSessionId, Request request)
                    throws Exception {
        ServiceLocator.findService(ResourceStoringManagement.class).deleteAttachment(
                deleteParameter.getAttachmentId());
    ...
    public Response handleGetInternally(GetAttachmentParameter getAttachmentParameter,
        ...
        AttachmentTO attachment = AttachmentResourceHelper.getResourceStoringManagement()
        ...
        if (asBinary != null && asBinary) {
            ...
            attachmentResource.setCrawlLastModificationDate(ServiceLocator.findService(
                    LastModificationDateManagement.class).getAttachmentCrawlLastModificationDate(
                    attachmentId));

            return ResponseHelper.buildSuccessResponse(attachmentResource, request);
        }
    }
