package com.communote.plugins.api.rest.v30.resource.topic.property;
...
public class PropertyResourceHandler
        extends
        DefaultResourceHandler<CreatePropertyParameter, DefaultParameter,
        DefaultParameter, GetPropertyParameter, GetCollectionPropertyParameter> {

    private static final PropertyType PROPERTY_TYPE = PropertyType.BlogProperty;
    ...
    public Response handleCreateInternally(CreatePropertyParameter createPropertyParameter,
        ...
        getPropertyManagement().setObjectProperty(PROPERTY_TYPE,
                Long.parseLong(createPropertyParameter.getTopicId()),
                createPropertyParameter.getKeyGroup(), createPropertyParameter.getKey(),
                createPropertyParameter.getValue());
    ...
    public Response handleGetInternally(GetPropertyParameter getPropertyParameter,
        ...
        StringProperty property = getPropertyManagement().getObjectProperty(PROPERTY_TYPE,
                Long.parseLong(getPropertyParameter.getTopicId()),
                getPropertyParameter.getKeyGroup(), getPropertyParameter.getKey());
    ...
    public Response handleListInternally(
        ...
        Set<StringPropertyTO> properties = getPropertyManagement().getAllObjectProperties(
                PROPERTY_TYPE, Long.parseLong(getCollectionPropertyParameter.getTopicId()));
