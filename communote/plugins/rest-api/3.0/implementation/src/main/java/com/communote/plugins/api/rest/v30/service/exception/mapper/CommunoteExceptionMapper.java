...
public class CommunoteExceptionMapper implements ExceptionMapper<Exception> {
    ...
    public Response toResponse(Exception exception) {
        ...
        Integer statusCode = ResponseHelper.getHttpCodeFromErrorCode(status.getErrorCode());
        if (statusCode == null) {
            statusCode = 500;
        }
        if (statusCode >= 500) {
        ...
        responseBuilder.status(ResponseHelper.getHttpCodeFromErrorCode(status.getErrorCode()));
