package com.communote.plugins.api.rest.v30.resource.timelinetopic;
...
import com.communote.plugins.api.rest.v30.converter.BlogDataToTimelineTopicConverter;
...
import com.communote.plugins.api.rest.v30.resource.timelinenote.TimelineNoteHelper;
...
public class TimelineTopicResourceHandler
    ...
    private TopicTimelineParameters configureQueryInstance(
        ...
        boolean sortByLatestNote = ParameterHelper.getParameterAsBoolean(
                parameters,
                ResourceHandlerHelper.getNameProvider(request).getNameForTopicSortByLatestNote(),
                false);
