...
import com.communote.plugins.api.rest.resource.user.property.PropertyResourceHelper;
...
public class UserResourceHandler
    ...
    /**
     * Configure the {@link UserQueryParameters} by the {@link GetCollectionUserParameter}
     *
    ...
    public Response handleListInternally(GetCollectionUserParameter getCollectionUserParameter,
        ...
        if (alias != null) {
            ...
            UserQueryParameters userQueryParameters = configureQueryInstance(getCollectionUserParameter);
