...
import com.communote.plugins.api.rest.resource.RestApiMultivaluedMapWrapper;
import com.communote.plugins.api.rest.resource.attachment.AttachmentResourceHelper;
import com.communote.plugins.api.rest.resource.timelinenote.timelinenotediscussion.TimelineNoteDiscussionResource;
import com.communote.plugins.api.rest.resource.timelinenote.timelinenotetag.TimelineNoteTagResource;
import com.communote.plugins.api.rest.resource.timelinetopic.TimelineTopicResource;
import com.communote.plugins.api.rest.resource.timelineuser.TimelineUserHelper;
...
public final class TimelineNoteHelper {
    ...
    public static TimelineNoteResource buildTimelineNoteResource(NoteData noteListData,
        ...
        target.setAuthor(TimelineUserHelper.buildTimelineUserResource(noteListData.getUser()));
