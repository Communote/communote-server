package com.communote.plugins.api.rest.response;
...
import com.communote.plugins.api.rest.to.ApiResult.ResultStatus;
...
public final class ResponseHelper {
    ...
    public static <T> Response buildResponse(T result, String message, Request request,
            ResultStatus status) throws ResponseBuildException, ExtensionNotSupportedException {
