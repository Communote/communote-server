package com.communote.plugins.api.rest.resource.user.image;
...
DefaultResourceHandler<DefaultParameter, DefaultParameter, DefaultParameter, GetImageParameter, DefaultParameter> {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(ImageResourceHandler.class);
    ...
    public Response handleGetInternally(GetImageParameter getImageParameter,
        ...
        try {
            ...
            LOG.debug("Was not able to get the image: " + e);
        }
        return Response.status(Response.Status.INTERNAL_SERVER_ERROR).build();
    }
}
