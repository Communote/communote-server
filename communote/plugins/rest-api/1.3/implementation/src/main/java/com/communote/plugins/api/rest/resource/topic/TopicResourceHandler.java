package com.communote.plugins.api.rest.resource.topic;
...
import com.communote.plugins.api.rest.resource.topic.property.PropertyResourceHelper;
...
DefaultResourceHandler<CreateTopicParameter, EditTopicParameter, DeleteTopicParameter, GetTopicParameter, GetCollectionTopicParameter> {
    ...
    public Response handleGetInternally(GetTopicParameter getTopicParameter,
        ...
        TopicResource topicResource = new TopicResource();
        TopicResourceHelper.CONVERTER.convert(new BlogToBlogTagListItemQueryResultConverter(
                ResourceHandlerHelper.getCurrentUserLocale(request)).convert(blog), topicResource);
