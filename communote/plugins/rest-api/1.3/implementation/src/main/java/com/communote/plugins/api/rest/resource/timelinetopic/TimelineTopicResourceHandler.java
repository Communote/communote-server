package com.communote.plugins.api.rest.resource.timelinetopic;
...
import com.communote.plugins.api.rest.converter.BlogDataToTimelineTopicConverter;
...
public class TimelineTopicResourceHandler
    ...
    private static UserTaggedBlogQuery TOPIC_QUERY_DEFINITION = QueryDefinitionRepository
    ...
    private TopicTimelineParameters configureQueryInstance(
        ...
        queryInstanceConfigurator = new TimelineQueryParametersConfigurator<TopicTimelineParameters>(
    ...
    public Response handleListInternally(
        ...
        TopicTimelineParameters queryParameters = configureQueryInstance(
                parameters, request);
        PageableList<TimelineTopicResource> blogListItems = ServiceLocator
                .instance().getService(QueryManagement.class)
                .query(TOPIC_QUERY_DEFINITION, queryParameters, CONVERTER);
