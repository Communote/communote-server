...
public class TimelineNoteResourceConverter extends
     ...
     */
    public TimelineNoteResourceConverter(NoteQueryParameters noteQueryInstance,
            NoteRenderContext renderContext) {
        this.threadedView = noteQueryInstance.isThreadedView();
        this.discussionId = noteQueryInstance.getDiscussionId();
