...
import com.communote.plugins.api.rest.v24.resource.RestApiMultivaluedMapWrapper;
import com.communote.plugins.api.rest.v24.resource.attachment.AttachmentResourceHelper;
import com.communote.plugins.api.rest.v24.resource.timelinenote.property.PropertyResource;
import com.communote.plugins.api.rest.v24.resource.timelinenote.timelinenotediscussion.TimelineNoteDiscussionResource;
import com.communote.plugins.api.rest.v24.resource.timelinenote.timelinenotetag.TimelineNoteTagResource;
import com.communote.plugins.api.rest.v24.resource.timelinetopic.TimelineTopicResource;
import com.communote.plugins.api.rest.v24.resource.timelineuser.TimelineUserHelper;
...
public final class TimelineNoteHelper {
    ...
    public static TimelineNoteResource buildTimelineNoteResource(NoteData noteListData,
        ...
        target.setIsMentionDiscussionAuthors(noteListData.isMentionDiscussionAuthors());
        target.setIsMentionTopicAuthors(noteListData.isMentionTopicAuthors());
        target.setIsMentionTopicManagers(noteListData.isMentionTopicManagers());
        target.setIsMentionTopicReaders(noteListData.isMentionTopicReaders());
