 ...
 */
public class TopicTagListItemToTopicResourceConverter<T extends BlogTagListItem>
        extends DataAccessBlogConverter<T, TopicResource> {
     ...
     */
    private void fillingResultItem(T topicTagListItem, TopicResource topicResource)
            throws BlogAccessException {
        ...
        topicResource.setIsFollow(ServiceLocator.findService(FollowManagement.class)
