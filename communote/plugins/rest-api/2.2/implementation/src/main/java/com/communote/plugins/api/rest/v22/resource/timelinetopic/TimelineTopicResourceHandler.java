package com.communote.plugins.api.rest.v22.resource.timelinetopic;
...
import com.communote.plugins.api.rest.v22.converter.BlogDataToTimelineTopicConverter;
...
public class TimelineTopicResourceHandler
    ...
    private TopicTimelineParameters configureQueryInstance(
            Map<String, ? extends Object> parameters, Request request) {
