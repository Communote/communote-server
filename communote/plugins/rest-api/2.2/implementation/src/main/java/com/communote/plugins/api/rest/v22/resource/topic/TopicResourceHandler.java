package com.communote.plugins.api.rest.v22.resource.topic;
...
import com.communote.plugins.api.rest.v22.resource.topic.externalobject.ExternalObjectResourceHelper;
import com.communote.plugins.api.rest.v22.resource.topic.property.PropertyResourceHelper;
import com.communote.plugins.api.rest.v22.resource.topic.role.RoleResourceHelper;
import com.communote.plugins.api.rest.v22.resource.topic.roleexternal.RoleExternalResourceHelper;
...
DefaultResourceHandler<CreateTopicParameter, EditTopicParameter, DeleteTopicParameter, GetTopicParameter, GetCollectionTopicParameter> {
    ...
    /**
     * Get the list of topics for the specified {@link BlogQueryParameters}
     *
    ...
    public Response handleCreateInternally(CreateTopicParameter createTopicParameter,
            String requestedMimeType, UriInfo uriInfo, String sessionId, Request request)
                    ...
                    ExternalObjectAlreadyAssignedException, ToplevelTopicCannotBeChildException,
    ...
    public Response handleGetInternally(GetTopicParameter getTopicParameter,
        ...
        Blog blog = getTopicManagement().getBlogById(topicId, true);

        TopicResource topicResource = new TopicResource();
        TopicResourceHelper.CONVERTER.convert(TopicResourceHelper.getBlogListItem(request, blog),
                topicResource);
