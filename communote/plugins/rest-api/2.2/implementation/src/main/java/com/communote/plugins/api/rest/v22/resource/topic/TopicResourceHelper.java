...
import com.communote.plugins.api.rest.v22.converter.TopicTagListItemToTopicResourceConverter;
...
public final class TopicResourceHelper {
    ...
    final static TopicTagListItemToTopicResourceConverter<BlogTagListItem, TopicResource> CONVERTER = new TopicTagListItemToTopicResourceConverter<BlogTagListItem, TopicResource>();
     ...
     * @param blog
     *            the topic
     * @return the blog list item.
     */
    public static BlogTagListItem getBlogListItem(Request request, Blog blog) {
        return new BlogToBlogTagListItemQueryResultConverter(
                ResourceHandlerHelper.getCurrentUserLocale(request)).convert(blog);
    }
