...
public interface ClientConfigurationDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.config.ClientConfiguration)}
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.config.ClientConfiguration}.
     * 
    ...
    /**
     * Updates the <code>clientConfiguration</code> instance in the persistent store.
     */
