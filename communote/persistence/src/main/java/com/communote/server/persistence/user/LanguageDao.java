...
public interface LanguageDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.user.Language)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.user.Language language);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.user.Language> entities);
     ...
     * </p>
     */
    public com.communote.server.model.user.Language findByLanguageCode(String languageCode);
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.user.Language}.
     * 
    ...
    /**
     * Updates the <code>language</code> instance in the persistent store.
     */
     ...
     */
    public void update(java.util.Collection<com.communote.server.model.user.Language> entities);
