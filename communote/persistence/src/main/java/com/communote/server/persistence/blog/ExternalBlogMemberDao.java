 ...
 */
public interface ExternalBlogMemberDao {
    /**
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.blog.ExternalBlogMember)}
     ...
     * 
     * @param entities
     *            the collection of com.communote.server.persistence.blog.ExternalBlogMember
     *            instances to create.
     * 
    ...
    /**
     * Loads an instance of com.communote.server.persistence.blog.ExternalBlogMember from the
     * persistent store.
     */
    public com.communote.server.model.blog.ExternalBlogMember load(Long id);

    /**
     * Loads all entities of type {@link com.communote.server.model.blog.ExternalBlogMember}.
     * 
    ...
    /**
     * Removes the instance of com.communote.server.persistence.blog.ExternalBlogMember from the
     * persistent store.
     */
    ...
    /**
     * Removes the instance of com.communote.server.persistence.blog.ExternalBlogMember having the
     * given <code>identifier</code> from the persistent store.
     */
    public void remove(Long id);

    /**
     * Updates the <code>externalBlogMember</code> instance in the persistent store.
     */
