 ...
 */
public interface ProcessedMailNoteDao {
    /**
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.note.ProcessedMailNote)}
 ...
 * 
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.note.ProcessedMailNote}.
     * 
    ...
    /**
     * Updates the <code>processedMailNote</code> instance in the persistent store.
     */
