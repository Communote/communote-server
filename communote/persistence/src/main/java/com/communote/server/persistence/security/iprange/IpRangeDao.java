...
public interface IpRangeDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.security.IpRange)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.security.IpRange ipRange);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.security.IpRange> entities);
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.security.IpRange}.
     * 
    ...
    /**
     * Updates the <code>ipRange</code> instance in the persistent store.
     */
     ...
     */
    public void update(java.util.Collection<com.communote.server.model.security.IpRange> entities);
