 ...
 */
public interface LdapSearchBaseDefinitionDao {
    /**
     ...
     * {@link #create(com.communote.server.model.config.LdapSearchBaseDefinition)} with an
     ...
     * 
     * @param entities
     *            the collection of com.communote.server.persistence.config.LdapSearchBaseDefinition
     *            instances to create.
     * 
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.config.LdapSearchBaseDefinition}
     * .
     * 
    ...
    /**
     * Updates the <code>ldapSearchBaseDefinition</code> instance in the persistent store.
     */
    public void update(
            com.communote.server.model.config.LdapSearchBaseDefinition ldapSearchBaseDefinition);
