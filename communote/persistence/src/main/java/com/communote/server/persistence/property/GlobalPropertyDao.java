...
/**
 * @see com.communote.server.model.property.GlobalProperty
 *
...
public interface GlobalPropertyDao {
     ...
     */
    public com.communote.server.model.property.GlobalProperty create(
            com.communote.server.model.property.GlobalProperty globalProperty);

    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.property.GlobalProperty)}
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.property.GlobalProperty> entities);
     ...
     */
    public java.util.Collection<com.communote.server.model.property.GlobalProperty> create(
            java.util.Collection<com.communote.server.model.property.GlobalProperty> entities);
     ...
     *            the entity to evict
     */
    public void evict(com.communote.server.model.property.GlobalProperty entity);
     ...
     * persistent store.
     */
    public com.communote.server.model.property.GlobalProperty load(Long id);

    /**
     * Loads all entities of type {@link com.communote.server.model.property.GlobalProperty}.
     * 
     * @return the loaded entities.
     */
    public java.util.Collection<com.communote.server.model.property.GlobalProperty> loadAll();
     ...
     * persistent store.
     */
    public void remove(com.communote.server.model.property.GlobalProperty globalProperty);
    ...
    /**
     * Updates the <code>globalProperty</code> instance in the persistent store.
     */
    public void update(com.communote.server.model.property.GlobalProperty globalProperty);
