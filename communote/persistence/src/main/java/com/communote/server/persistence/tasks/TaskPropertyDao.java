 ...
 */
public interface TaskPropertyDao {
    /**
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.task.TaskProperty)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.task.TaskProperty taskProperty);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.task.TaskProperty> entities);
     ...
     * 
     * @param entities
     *            the collection of com.communote.server.persistence.tasks.TaskProperty instances to
     *            create.
     * 
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.task.TaskProperty}.
     * 
    ...
    /**
     * Updates the <code>taskProperty</code> instance in the persistent store.
     */
     ...
     */
    public void update(java.util.Collection<com.communote.server.model.task.TaskProperty> entities);
