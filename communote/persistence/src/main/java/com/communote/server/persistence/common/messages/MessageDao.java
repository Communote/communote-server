...
public interface MessageDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.i18n.Message)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.i18n.Message message);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.i18n.Message> entities);
     ...
     * </p>
     */
    public java.util.Collection<com.communote.server.model.i18n.Message> find(String key);
     ...
     * </p>
     */
    public com.communote.server.model.i18n.Message find(String key, String languageCode);

    /**
     * <p>
     * Returns the specified message. Returns the message fallback if the original message was not
     * found.
     * </p>
     */
    public com.communote.server.model.i18n.Message find(String key, String languageCode,
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.i18n.Message}.
     *
     ...
     */
    public void update(java.util.Collection<com.communote.server.model.i18n.Message> entities);
