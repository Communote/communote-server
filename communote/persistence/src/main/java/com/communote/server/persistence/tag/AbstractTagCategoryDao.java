 ...
 */
public interface AbstractTagCategoryDao {
    /**
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.tag.AbstractTagCategory)}
     ...
     * 
     * @param entities
     *            the collection of com.communote.server.persistence.tag.AbstractTagCategory
     *            instances to create.
     * 
    ...
    /**
     * Loads an instance of com.communote.server.persistence.tag.AbstractTagCategory from the
     * persistent store.
     */
    public com.communote.server.model.tag.AbstractTagCategory load(Long id);

    /**
     * Loads all entities of type {@link com.communote.server.model.tag.AbstractTagCategory}.
     * 
    ...
    /**
     * Removes the instance of com.communote.server.persistence.tag.AbstractTagCategory from the
     * persistent store.
     */
    ...
    /**
     * Removes the instance of com.communote.server.persistence.tag.AbstractTagCategory having the
     * given <code>identifier</code> from the persistent store.
     */
    public void remove(Long id);

    /**
     * Updates the <code>abstractTagCategory</code> instance in the persistent store.
     */
