...
public interface AuthenticationFailedStatusDao {
     ...
     * {@link #create(com.communote.server.model.user.security.AuthenticationFailedStatus)} with an
 ...
 * 
    ...
    /**
     * Updates the <code>authenticationFailedStatus</code> instance in the persistent store.
     */
    public void update(
            com.communote.server.model.user.security.AuthenticationFailedStatus authenticationFailedStatus);
     ...
     * </p>
     */
    public void updateLockedTimeout(long failedAuthStatusId, java.sql.Timestamp lockedTimeout);
