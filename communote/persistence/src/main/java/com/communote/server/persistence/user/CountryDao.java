...
public interface CountryDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.user.Country)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.user.Country country);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.user.Country> entities);
     ...
     * </p>
     */
    public com.communote.server.model.user.Country findCountryByCode(String countryCode);
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.user.Country}.
     * 
    ...
    /**
     * Updates the <code>country</code> instance in the persistent store.
     */
     ...
     */
    public void update(java.util.Collection<com.communote.server.model.user.Country> entities);
