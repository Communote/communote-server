 ...
 */
public interface UnlockUserSecurityCodeDao {
    /**
     ...
     * {@link #create(com.communote.server.model.user.security.UnlockUserSecurityCode)} with an
    ...
    /**
     * Updates the <code>unlockUserSecurityCode</code> instance in the persistent store.
     */
    public void update(
            com.communote.server.model.user.security.UnlockUserSecurityCode unlockUserSecurityCode);
