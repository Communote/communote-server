 ...
 */
public interface UserNoteEntityDao {
    /**
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.user.note.UserNoteEntity)}
     ...
     * </p>
     */
    public com.communote.server.model.user.note.UserNoteEntity findByUserIdNoteId(Long userId,
            Long noteId);
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.user.note.UserNoteEntity}.
     * 
    ...
    /**
     * Updates the <code>userNoteEntity</code> instance in the persistent store.
     */
