 ...
 */
public interface IpRangeFilterDao {
    /**
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.security.IpRangeFilter)}
     ...
     * 
     * @param entities
     *            the collection of com.communote.server.persistence.security.iprange.IpRangeFilter
     *            instances to create.
     * 
    ...
    /**
     * Loads an instance of com.communote.server.persistence.security.iprange.IpRangeFilter from the
     * persistent store.
     */
    public com.communote.server.model.security.IpRangeFilter load(Long id);

    /**
     * Loads all entities of type {@link com.communote.server.model.security.IpRangeFilter}.
     * 
    ...
    /**
     * Removes the instance of com.communote.server.persistence.security.iprange.IpRangeFilter from
    ...
    /**
     * Removes the instance of com.communote.server.persistence.security.iprange.IpRangeFilter
     * having the given <code>identifier</code> from the persistent store.
     */
    public void remove(Long id);

    /**
     * Updates the <code>ipRangeFilter</code> instance in the persistent store.
     */
