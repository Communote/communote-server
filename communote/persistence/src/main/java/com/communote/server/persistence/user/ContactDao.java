...
public interface ContactDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.user.Contact)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.user.Contact contact);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.user.Contact> entities);
     ...
     * 
     * @param entities
     *            the collection of com.communote.server.persistence.user.Contact instances to
     *            create.
     * 
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.user.Contact}.
     * 
    ...
    /**
     * Updates the <code>contact</code> instance in the persistent store.
     */
     ...
     */
    public void update(java.util.Collection<com.communote.server.model.user.Contact> entities);
