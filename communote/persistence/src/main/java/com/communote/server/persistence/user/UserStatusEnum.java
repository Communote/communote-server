 ...
 */
public final class UserStatusEnum extends UserStatus implements java.io.Serializable, Comparable,
    ...
    public Object fromXMLString(String string) {
        return com.communote.server.model.user.UserStatus.fromString(String.valueOf(string));
    }
    ...
    public String objectToSQLString(Object object) {
        return String.valueOf(((com.communote.server.model.user.UserStatus) object).getValue());
    }
