...
public interface ClientStatisticDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.client.ClientStatistic)}
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.client.ClientStatistic}.
     * 
    ...
    /**
     * Updates the <code>clientStatistic</code> instance in the persistent store.
     */
