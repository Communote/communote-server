...
/**
 * @see com.communote.server.model.note.Content
 *
...
public interface ContentDao {
     ...
     * persistent store.
     */
    public com.communote.server.model.note.Content create(
            com.communote.server.model.note.Content content);

    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.note.Content)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.note.Content content);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.note.Content> entities);
     ...
     */
    public java.util.Collection<com.communote.server.model.note.Content> create(
            java.util.Collection<com.communote.server.model.note.Content> entities);
     ...
     *            the entity to evict
     */
    public void evict(com.communote.server.model.note.Content entity);
     ...
     * store.
     */
    public com.communote.server.model.note.Content load(Long id);

    /**
     * Loads all entities of type {@link com.communote.server.model.note.Content}.
     * 
     * @return the loaded entities.
     */
    public java.util.Collection<com.communote.server.model.note.Content> loadAll();
     ...
     * store.
     */
    public void remove(com.communote.server.model.note.Content content);

    /**
     * Removes all entities in the given <code>entities<code> collection.
     */
    public void remove(java.util.Collection<com.communote.server.model.note.Content> entities);
    ...
    /**
     * Updates the <code>content</code> instance in the persistent store.
     */
    public void update(com.communote.server.model.note.Content content);

    /**
     * Updates all instances in the <code>entities</code> collection in the persistent store.
     */
    public void update(java.util.Collection<com.communote.server.model.note.Content> entities);
