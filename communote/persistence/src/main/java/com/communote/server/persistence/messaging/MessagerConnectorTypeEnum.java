package com.communote.server.persistence.messaging;
 ...
 */
public final class MessagerConnectorTypeEnum extends MessagerConnectorType implements
        java.io.Serializable, Comparable, org.hibernate.usertype.EnhancedUserType {
     ...
     */
    public MessagerConnectorTypeEnum() {
        super();
    }
    ...
    public Object fromXMLString(String string) {
        return com.communote.server.model.messaging.MessagerConnectorType.fromString(String
                .valueOf(string));
    }
    ...
    public String objectToSQLString(Object object) {
        return String.valueOf(((com.communote.server.model.messaging.MessagerConnectorType) object)
                .getValue());
    }
    ...
    public Class returnedClass() {
        return MessagerConnectorType.class;
    }
