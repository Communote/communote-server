 ...
 */
public interface EmailSecurityCodeDao {
    /**
     ...
     * {@link #create(com.communote.server.model.user.security.EmailSecurityCode)} with an
     ...
     * </p>
     */
    public com.communote.server.model.user.security.EmailSecurityCode findBySecurityCode(String code);
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.user.security.EmailSecurityCode}
     * .
     * 
    ...
    /**
     * Updates the <code>emailSecurityCode</code> instance in the persistent store.
     */
