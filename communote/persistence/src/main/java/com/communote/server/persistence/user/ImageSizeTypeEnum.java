 ...
 */
public final class ImageSizeTypeEnum extends ImageSizeType implements java.io.Serializable,
        Comparable, org.hibernate.usertype.EnhancedUserType {
    ...
    public Object fromXMLString(String string) {
        return com.communote.server.model.user.ImageSizeType.fromString(String.valueOf(string));
    }
    ...
    public String objectToSQLString(Object object) {
        return String.valueOf(((com.communote.server.model.user.ImageSizeType) object).getValue());
    }
