 ...
 */
public interface LdapSearchConfigurationDao {
    /**
     ...
     * {@link #create(com.communote.server.model.config.LdapSearchConfiguration)} with an additional
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.config.LdapSearchConfiguration}.
     * 
    ...
    /**
     * Updates the <code>ldapSearchConfiguration</code> instance in the persistent store.
     */
    public void update(
            com.communote.server.model.config.LdapSearchConfiguration ldapSearchConfiguration);
