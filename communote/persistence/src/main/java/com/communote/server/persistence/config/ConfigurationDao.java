...
public interface ConfigurationDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.config.Configuration)} with
     ...
     * 
     * @param entities
     *            the collection of com.communote.server.persistence.config.Configuration instances
     *            to create.
     * 
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.config.Configuration}.
     * 
    ...
    /**
     * Updates the <code>configuration</code> instance in the persistent store.
     */
