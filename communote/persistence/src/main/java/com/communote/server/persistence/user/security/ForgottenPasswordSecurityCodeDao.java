...
public interface ForgottenPasswordSecurityCodeDao {
     ...
     * {@link #create(com.communote.server.model.user.security.ForgottenPasswordSecurityCode)} with
 ...
 * 
    ...
    /**
     * Updates the <code>forgottenPasswordSecurityCode</code> instance in the persistent store.
     */
    public void update(
            com.communote.server.model.user.security.ForgottenPasswordSecurityCode forgottenPasswordSecurityCode);
