...
public interface UserAuthorityDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.user.UserAuthority)} with an
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.user.UserAuthority> entities);

    /**
     * Creates a new instance of UserAuthority and adds from the passed in <code>entities</code>
     * collection
     *
     * @param entities
     *            the collection of UserAuthority instances to create.
     *
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.user.UserAuthority}.
     *
    ...
    /**
     * Removes the instance of UserAuthority having the given <code>identifier</code> from the
     * persistent store.
     */
    public void remove(Long id);

    /**
     * Updates the <code>UserAuthority</code> instance in the persistent store.
     */
     ...
     */
    public void update(java.util.Collection<com.communote.server.model.user.UserAuthority> entities);
