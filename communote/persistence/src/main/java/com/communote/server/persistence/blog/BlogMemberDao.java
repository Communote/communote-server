...
public interface BlogMemberDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.blog.BlogMember)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.blog.BlogMember blogMember);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.blog.BlogMember> entities);
     ...
     * </p>
     */
    public java.util.Map<Long, com.communote.server.model.blog.BlogRole> getBlogRoles(Long blogId,
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.blog.BlogMember}.
     * 
    ...
    /**
     * Updates the <code>blogMember</code> instance in the persistent store.
     */
     ...
     */
    public void update(java.util.Collection<com.communote.server.model.blog.BlogMember> entities);
