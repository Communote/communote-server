 ...
 */
public interface ConfluenceConfigurationDao {
    /**
     ...
     * {@link #create(com.communote.server.model.config.ConfluenceConfiguration)} with an additional
     ...
     * 
     * @param entities
     *            the collection of com.communote.server.persistence.config.ConfluenceConfiguration
     *            instances to create.
     * 
    ...
    /**
     * Loads an instance of com.communote.server.persistence.config.ConfluenceConfiguration from the
     * persistent store.
     */
    public com.communote.server.model.config.ConfluenceConfiguration load(Long id);

    /**
     * Loads all entities of type {@link com.communote.server.model.config.ConfluenceConfiguration}.
     * 
    ...
    /**
     * Removes the instance of com.communote.server.persistence.config.ConfluenceConfiguration from
    ...
    /**
     * Removes the instance of com.communote.server.persistence.config.ConfluenceConfiguration
     * having the given <code>identifier</code> from the persistent store.
     */
    public void remove(Long id);

    /**
     * Updates the <code>confluenceConfiguration</code> instance in the persistent store.
     */
    public void update(
            com.communote.server.model.config.ConfluenceConfiguration confluenceConfiguration);
