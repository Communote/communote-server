...
public interface UserImageDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.user.UserImage)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.user.UserImage userImage);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.user.UserImage> entities);
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.user.UserImage}.
     * 
    ...
    /**
     * Updates the <code>userImage</code> instance in the persistent store.
     */
     ...
     */
    public void update(java.util.Collection<com.communote.server.model.user.UserImage> entities);
