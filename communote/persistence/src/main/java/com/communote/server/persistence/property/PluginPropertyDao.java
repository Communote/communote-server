...
public interface PluginPropertyDao {
     ...
     */
    public com.communote.server.model.property.PluginProperty create(
            com.communote.server.model.property.PluginProperty pluginProperty);

    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.property.PluginProperty)}
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.property.PluginProperty> entities);
     ...
     */
    public java.util.Collection<com.communote.server.model.property.PluginProperty> create(
            java.util.Collection<com.communote.server.model.property.PluginProperty> entities);
     ...
     *            the entity to evict
     */
    public void evict(com.communote.server.model.property.PluginProperty entity);

    /**
 * 
     */
    public com.communote.server.model.property.PluginProperty find(String symbolicName,
            String propertyKey);

    /**
     * <p>
     * 
     * @return A map of all keys to values for the given bundle.
     *         </p>
     */
    public java.util.Map<String, String> getAllProperties(String symbolicName,
     ...
     * persistent store.
     */
    public com.communote.server.model.property.PluginProperty load(Long id);

    /**
     * Loads all entities of type {@link com.communote.server.model.property.PluginProperty}.
     * 
     * @return the loaded entities.
     */
    public java.util.Collection<com.communote.server.model.property.PluginProperty> loadAll();
     ...
     * persistent store.
     */
    public void remove(com.communote.server.model.property.PluginProperty pluginProperty);
    ...
    /**
     * Updates the <code>pluginProperty</code> instance in the persistent store.
     */
    public void update(com.communote.server.model.property.PluginProperty pluginProperty);
