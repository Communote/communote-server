package com.communote.server.persistence.note;
 ...
 */
public final class NoteCreationSourceEnum
    extends NoteCreationSource
     ...
     * in {@link #nullSafeGet(java.sql.ResultSet, String[], Object)}.
     */
    public NoteCreationSourceEnum()
    {
        super();
    }
    ...
    {
        return NoteCreationSource.class;
    }
    ...
    {
        return String.valueOf(((com.communote.server.model.note.NoteCreationSource)object).getValue());
    }
    ...
    {
        return com.communote.server.model.note.NoteCreationSource.fromString(String.valueOf(string));
    }
}