 ...
 */
public final class UserRoleEnum extends UserRole implements java.io.Serializable, Comparable,
    ...
    public Object fromXMLString(String string) {
        return com.communote.server.model.user.UserRole.fromString(String.valueOf(string));
    }
    ...
    public String objectToSQLString(Object object) {
        return String.valueOf(((com.communote.server.model.user.UserRole) object).getValue());
    }
