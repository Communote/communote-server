 ...
 */
public interface ExternalObjectDao {
    /**
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.external.ExternalObject)}
     ...
     * 
     * @param entities
     *            the collection of com.communote.server.persistence.external.ExternalObject
     *            instances to create.
     * 
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.external.ExternalObject}.
     * 
    ...
    /**
     * Updates the <code>externalObject</code> instance in the persistent store.
     */
