...
/**
 * @see com.communote.server.model.blog.BlogProperty
 *
 * @author Communote GmbH - <a href="http://www.communote.com/">http://www.communote.com/</a>
 */
public interface BlogPropertyDao {
    /**
     ...
     * persistent store.
     */
    public com.communote.server.model.blog.BlogProperty create(
            com.communote.server.model.blog.BlogProperty blogProperty);

    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.blog.BlogProperty)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.blog.BlogProperty blogProperty);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.blog.BlogProperty> entities);
     ...
     * 
     * @param entities
     *            the collection of com.communote.server.persistence.blog.BlogProperty instances to
     *            create.
     * 
     * @return the created instances.
     */
    public java.util.Collection<com.communote.server.model.blog.BlogProperty> create(
            java.util.Collection<com.communote.server.model.blog.BlogProperty> entities);
     ...
     *            the entity to evict
     */
    public void evict(com.communote.server.model.blog.BlogProperty entity);
     ...
     * store.
     */
    public com.communote.server.model.blog.BlogProperty load(Long id);

    /**
     * Loads all entities of type {@link com.communote.server.model.blog.BlogProperty}.
     * 
     * @return the loaded entities.
     */
    public java.util.Collection<com.communote.server.model.blog.BlogProperty> loadAll();
     ...
     * persistent store.
     */
    public void remove(com.communote.server.model.blog.BlogProperty blogProperty);

    /**
     * Removes all entities in the given <code>entities<code> collection.
     */
    public void remove(java.util.Collection<com.communote.server.model.blog.BlogProperty> entities);
    ...
    /**
     * Updates the <code>blogProperty</code> instance in the persistent store.
     */
    public void update(com.communote.server.model.blog.BlogProperty blogProperty);

    /**
     * Updates all instances in the <code>entities</code> collection in the persistent store.
     */
    public void update(java.util.Collection<com.communote.server.model.blog.BlogProperty> entities);
