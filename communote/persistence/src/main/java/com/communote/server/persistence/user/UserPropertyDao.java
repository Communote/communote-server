...
/**
 * @see com.communote.server.model.user.UserProperty
 *
...
public interface UserPropertyDao {
     ...
     * persistent store.
     */
    public com.communote.server.model.user.UserProperty create(
            com.communote.server.model.user.UserProperty userProperty);

    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.user.UserProperty)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.user.UserProperty userProperty);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.user.UserProperty> entities);
     ...
     * 
     * @param entities
     *            the collection of com.communote.server.persistence.user.UserProperty instances to
     *            create.
     * 
     * @return the created instances.
     */
    public java.util.Collection<com.communote.server.model.user.UserProperty> create(
            java.util.Collection<com.communote.server.model.user.UserProperty> entities);
     ...
     *            the entity to evict
     */
    public void evict(com.communote.server.model.user.UserProperty entity);
     ...
     * store.
     */
    public com.communote.server.model.user.UserProperty load(Long id);

    /**
     * Loads all entities of type {@link com.communote.server.model.user.UserProperty}.
     * 
     * @return the loaded entities.
     */
    public java.util.Collection<com.communote.server.model.user.UserProperty> loadAll();
     ...
     * persistent store.
     */
    public void remove(com.communote.server.model.user.UserProperty userProperty);

    /**
     * Removes all entities in the given <code>entities<code> collection.
     */
    public void remove(java.util.Collection<com.communote.server.model.user.UserProperty> entities);
    ...
    /**
     * Updates the <code>userProperty</code> instance in the persistent store.
     */
    public void update(com.communote.server.model.user.UserProperty userProperty);

    /**
     * Updates all instances in the <code>entities</code> collection in the persistent store.
     */
    public void update(java.util.Collection<com.communote.server.model.user.UserProperty> entities);
