 ...
 */
public interface ExternalSystemConfigurationDao {
    /**
     ...
     * {@link #create(com.communote.server.model.config.ExternalSystemConfiguration)} with an
     ...
     * </p>
     */
    public Long findBySystemId(String systemId);
     ...
     * {@link com.communote.server.model.config.ExternalSystemConfiguration}.
     * 
    ...
    /**
     * Updates the <code>externalSystemConfiguration</code> instance in the persistent store.
     */
    public void update(
            com.communote.server.model.config.ExternalSystemConfiguration externalSystemConfiguration);
