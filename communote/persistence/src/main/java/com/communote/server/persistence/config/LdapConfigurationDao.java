...
public interface LdapConfigurationDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.config.LdapConfiguration)}
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.config.LdapConfiguration}.
     * 
    ...
    /**
     * Updates the <code>ldapConfiguration</code> instance in the persistent store.
     */
