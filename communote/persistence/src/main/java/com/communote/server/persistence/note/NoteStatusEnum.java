 ...
 */
public final class NoteStatusEnum
    extends NoteStatus
    ...
    {
        return String.valueOf(((com.communote.server.model.note.NoteStatus)object).getValue());
    }
    ...
    {
        return com.communote.server.model.note.NoteStatus.fromString(String.valueOf(string));
    }
}