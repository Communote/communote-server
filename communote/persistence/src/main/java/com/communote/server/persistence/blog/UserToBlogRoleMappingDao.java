...
public interface UserToBlogRoleMappingDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.blog.UserToBlogRoleMapping)}
    ...
    /**
     * Retrieves mappings matching the parameters. The externalSystemId is ignored.
     * 
     ...
     */
    public java.util.Collection<com.communote.server.model.blog.UserToBlogRoleMapping> findMappings(
            Long blogId, Long userId, Long groupId, Boolean grantedByGroup, BlogRole role);
     ...
     * </p>
     */
    public com.communote.server.model.blog.BlogRole getRoleOfUser(Long blogId, Long userId);
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.blog.UserToBlogRoleMapping}.
     * 
     ...
     * </p>
     */
    public void removeAllForBlog(Long blogId);

    /**
 * 
     */
    public void removeAllForGroup(Long groupId);
     ...
     * </p>
     */
    public void removeAllForGroupMember(Long userId, Long groupId);

    /**
     * Updates the <code>userToBlogRoleMapping</code> instance in the persistent store.
     */
