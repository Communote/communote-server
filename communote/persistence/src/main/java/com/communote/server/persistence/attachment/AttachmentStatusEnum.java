package com.communote.server.persistence.attachment;
 ...
 */
public final class AttachmentStatusEnum
    extends AttachmentStatus
    ...
    {
        return String.valueOf(((com.communote.server.model.attachment.AttachmentStatus)object).getValue());
    }
    ...
    {
        return com.communote.server.model.attachment.AttachmentStatus.fromString(String.valueOf(string));
    }
}