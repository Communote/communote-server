 ...
 */
public final class UserOfGroupModificationTypeEnum extends UserOfGroupModificationType implements
     ...
     */
    public UserOfGroupModificationTypeEnum() {
        super();
    }
    ...
    public Object fromXMLString(String string) {
        return com.communote.server.model.user.group.UserOfGroupModificationType.fromString(String
                .valueOf(string));
    }
    ...
    public String objectToSQLString(Object object) {
        return String
                .valueOf(((com.communote.server.model.user.group.UserOfGroupModificationType) object)
                        .getValue());
    }
    ...
    public Class returnedClass() {
        return UserOfGroupModificationType.class;
    }
