 ...
 */
public interface IpRangeChannelDao {
    /**
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.security.IpRangeChannel)}
 ...
 * 
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.security.IpRangeChannel}.
     * 
    ...
    /**
     * Updates the <code>ipRangeChannel</code> instance in the persistent store.
     */
