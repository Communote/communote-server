...
/**
 * @see com.communote.server.model.config.Setting
 *
...
public interface SettingDao {
     ...
     * persistent store.
     */
    public com.communote.server.model.config.Setting create(
            com.communote.server.model.config.Setting setting);

    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.config.Setting)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.config.Setting setting);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.config.Setting> entities);
     ...
     */
    public java.util.Collection<com.communote.server.model.config.Setting> create(
            java.util.Collection<com.communote.server.model.config.Setting> entities);
     ...
     *            the entity to evict
     */
    public void evict(com.communote.server.model.config.Setting entity);

    /**
     * <p>
     * Does the same thing as {@link #load(String)} with an additional flag called
     ...
     */
    public Object load(int transform, String settingKey);

    /**
     * Loads an instance of com.communote.server.persistence.config.Setting from the persistent
     * store.
     */
    public com.communote.server.model.config.Setting load(String settingKey);

    /**
     * Loads all entities of type {@link com.communote.server.model.config.Setting}.
     * 
     * @return the loaded entities.
     */
    public java.util.Collection<com.communote.server.model.config.Setting> loadAll();
     ...
     * store.
     */
    public void remove(com.communote.server.model.config.Setting setting);

    /**
     * Removes all entities in the given <code>entities<code> collection.
     */
    public void remove(java.util.Collection<com.communote.server.model.config.Setting> entities);
    ...
    /**
     * Updates the <code>setting</code> instance in the persistent store.
     */
    public void update(com.communote.server.model.config.Setting setting);

    /**
     * Updates all instances in the <code>entities</code> collection in the persistent store.
     */
    public void update(java.util.Collection<com.communote.server.model.config.Setting> entities);
