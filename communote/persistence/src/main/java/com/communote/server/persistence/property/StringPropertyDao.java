...
/**
 * @see com.communote.server.model.property.StringProperty
 *
 * @author Communote GmbH - <a href="http://www.communote.com/">http://www.communote.com/</a>
 */
public interface StringPropertyDao {
    /**
     ...
     */
    public com.communote.server.model.property.StringProperty create(
            com.communote.server.model.property.StringProperty stringProperty);

    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.property.StringProperty)}
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.property.StringProperty> entities);
     ...
     */
    public java.util.Collection<com.communote.server.model.property.StringProperty> create(
            java.util.Collection<com.communote.server.model.property.StringProperty> entities);
     ...
     *            the entity to evict
     */
    public void evict(com.communote.server.model.property.StringProperty entity);
     ...
     * persistent store.
     */
    public com.communote.server.model.property.StringProperty load(Long id);

    /**
     * Loads all entities of type {@link com.communote.server.model.property.StringProperty}.
     * 
     * @return the loaded entities.
     */
    public java.util.Collection<com.communote.server.model.property.StringProperty> loadAll();
     ...
     * persistent store.
     */
    public void remove(com.communote.server.model.property.StringProperty stringProperty);
    ...
    /**
     * Updates the <code>stringProperty</code> instance in the persistent store.
     */
    public void update(com.communote.server.model.property.StringProperty stringProperty);
