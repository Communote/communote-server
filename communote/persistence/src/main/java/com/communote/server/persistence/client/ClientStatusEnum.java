package com.communote.server.persistence.client;
 ...
 */
public final class ClientStatusEnum
    extends ClientStatus
    ...
    {
        return String.valueOf(((com.communote.server.model.client.ClientStatus)object).getValue());
    }
    ...
    {
        return com.communote.server.model.client.ClientStatus.fromString(String.valueOf(string));
    }
}