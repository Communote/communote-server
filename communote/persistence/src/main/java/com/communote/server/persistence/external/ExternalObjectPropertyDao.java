...
/**
 * @see com.communote.server.model.external.ExternalObjectProperty
 *
 * @author Communote GmbH - <a href="http://www.communote.com/">http://www.communote.com/</a>
 */
public interface ExternalObjectPropertyDao {
    /**
     ...
     */
    public com.communote.server.model.external.ExternalObjectProperty create(
            com.communote.server.model.external.ExternalObjectProperty externalObjectProperty);

    /**
     * <p>
     * Does the same thing as
     * {@link #create(com.communote.server.model.external.ExternalObjectProperty)} with an
    ...
    public java.util.Collection<?> create(
            int transform,
            java.util.Collection<com.communote.server.model.external.ExternalObjectProperty> entities);
     ...
     */
    public java.util.Collection<com.communote.server.model.external.ExternalObjectProperty> create(
            java.util.Collection<com.communote.server.model.external.ExternalObjectProperty> entities);
     ...
     *            the entity to evict
     */
    public void evict(com.communote.server.model.external.ExternalObjectProperty entity);
     ...
     */
    public com.communote.server.model.external.ExternalObjectProperty load(Long id);

    /**
     * Loads all entities of type {@link com.communote.server.model.external.ExternalObjectProperty}
     * .
     * 
     * @return the loaded entities.
     */
    public java.util.Collection<com.communote.server.model.external.ExternalObjectProperty> loadAll();
    ...
    /**
     * Updates the <code>externalObjectProperty</code> instance in the persistent store.
     */
    public void update(
            com.communote.server.model.external.ExternalObjectProperty externalObjectProperty);
