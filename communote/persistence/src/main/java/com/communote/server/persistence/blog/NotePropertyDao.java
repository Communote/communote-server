...
/**
 * @see com.communote.server.model.note.NoteProperty
 *
 * @author Communote GmbH - <a href="http://www.communote.com/">http://www.communote.com/</a>
 */
public interface NotePropertyDao {
    /**
     ...
     * persistent store.
     */
    public com.communote.server.model.note.NoteProperty create(
            com.communote.server.model.note.NoteProperty noteProperty);

    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.note.NoteProperty)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.note.NoteProperty noteProperty);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.note.NoteProperty> entities);
     ...
     * 
     * @param entities
     *            the collection of com.communote.server.persistence.blog.NoteProperty instances to
     *            create.
     * 
     * @return the created instances.
     */
    public java.util.Collection<com.communote.server.model.note.NoteProperty> create(
            java.util.Collection<com.communote.server.model.note.NoteProperty> entities);
     ...
     *            the entity to evict
     */
    public void evict(com.communote.server.model.note.NoteProperty entity);
     ...
     * store.
     */
    public com.communote.server.model.note.NoteProperty load(Long id);

    /**
     * Loads all entities of type {@link com.communote.server.model.note.NoteProperty}.
     * 
     * @return the loaded entities.
     */
    public java.util.Collection<com.communote.server.model.note.NoteProperty> loadAll();
     ...
     * persistent store.
     */
    public void remove(com.communote.server.model.note.NoteProperty noteProperty);

    /**
     * Removes all entities in the given <code>entities<code> collection.
     */
    public void remove(java.util.Collection<com.communote.server.model.note.NoteProperty> entities);
    ...
    /**
     * Updates the <code>noteProperty</code> instance in the persistent store.
     */
    public void update(com.communote.server.model.note.NoteProperty noteProperty);

    /**
     * Updates all instances in the <code>entities</code> collection in the persistent store.
     */
    public void update(java.util.Collection<com.communote.server.model.note.NoteProperty> entities);
