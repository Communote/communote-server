...
public interface NotificationConfigDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.user.NotificationConfig)}
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.user.NotificationConfig}.
     * 
    ...
    /**
     * Updates the <code>notificationConfig</code> instance in the persistent store.
     */
