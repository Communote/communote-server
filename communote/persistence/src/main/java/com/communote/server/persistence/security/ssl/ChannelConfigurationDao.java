...
public interface ChannelConfigurationDao {
     ...
     * {@link #create(com.communote.server.model.security.ChannelConfiguration)} with an additional
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.security.ChannelConfiguration}.
     * 
    ...
    /**
     * Updates the <code>channelConfiguration</code> instance in the persistent store.
     */
