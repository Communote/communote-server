...
public interface TaskDao {
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(com.communote.server.model.task.Task)} with an
     ...
     * </p>
     */
    public Object create(int transform, com.communote.server.model.task.Task task);
    ...
    public java.util.Collection<?> create(int transform,
            java.util.Collection<com.communote.server.model.task.Task> entities);
     ...
     * 
     * @param entities
     *            the collection of com.communote.server.persistence.tasks.Task instances to create.
     * 
     ...
     * <p>
     * 
     * @return Returns the next task to schedule or null if there is none.
     *         </p>
     */
     ...
     * <p>
     * 
     * @return The task specified by its name or null.
     *         </p>
     */
    public com.communote.server.model.task.Task findTaskByUniqueName(String uniqueName);
    ...
    /**
     * Loads all entities of type {@link com.communote.server.model.task.Task}.
     * 
     ...
     */
    public void update(java.util.Collection<com.communote.server.model.task.Task> entities);
