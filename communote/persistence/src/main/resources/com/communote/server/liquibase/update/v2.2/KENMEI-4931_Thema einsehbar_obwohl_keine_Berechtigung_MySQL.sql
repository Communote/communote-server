...
-- Daten in core_role2blog einfuegen
    ...
    INSERT INTO core_role2blog (blog_id, user_id, numeric_role, external_system_id, granted_by_group)
        SELECT DISTINCT core_blog_member.blog_fk as blogId, user_of_group.user_fk as userId, 1, core_blog_member.external_system_id as externalSystemId, true
    ...
    INSERT INTO core_role2blog (blog_id, user_id, numeric_role, external_system_id, granted_by_group)
        SELECT DISTINCT core_blog_member.blog_fk as blogId, user_of_group.user_fk as userId, 3, core_blog_member.external_system_id as externalSystemId, true
        FROM user_of_group, core_blog_member, user_group 
        WHERE 
        core_blog_member.kenmei_entity_fk  = user_group.id 
