...
public class ImageSizeType implements java.io.Serializable {
     ...
     */
    private static final long serialVersionUID = 2571807704140581888L;

    /**
     * 
     */
    public static final ImageSizeType SMALL = new ImageSizeType("SMALL");

    /**
     * 
     */
    public static final ImageSizeType MEDIUM = new ImageSizeType("MEDIUM");

    /**
     * 
     */
    public static final ImageSizeType LARGE = new ImageSizeType("LARGE");

    private static final java.util.Map<String, ImageSizeType> values = new java.util.HashMap<String, ImageSizeType>(
            3, 1);
    ...
    /**
     * Creates an instance of ImageSizeType from <code>value</code>.
     *
     * @param value
     *            the value to create the ImageSizeType from.
     */
    public static ImageSizeType fromString(String value) {
        final ImageSizeType typeValue = values.get(value);
        if (typeValue == null) {
    ...
    public int compareTo(Object that) {
        return (this == that) ? 0 : this.getValue().compareTo(((ImageSizeType) that).getValue());
    }
    ...
    public boolean equals(Object object) {
        return (this == object)
                || (object instanceof ImageSizeType && ((ImageSizeType) object).getValue().equals(
                        this.getValue()));
    }
    ...
    private Object readResolve() throws java.io.ObjectStreamException {
        return ImageSizeType.fromString(this.value);
    }
